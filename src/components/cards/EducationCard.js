      ...
      <li className="p-4 ">
        <div className="flex items-center space-x-4">
          ...
          <p className="py-1 text-sm text-gray-500 truncate dark:text-gray-400">
              {props.EducationObject.education}
            </p>
            <p className="text-lg font-medium text-gray-900 truncate dark:text-white">
              {props.EducationObject.institute}{" "}
            </p>
            <p className="py-1 text-xs text-gray-500 truncate dark:text-grey-500">
            {props.EducationObject.start} - {props.EducationObject.end }  | {props.EducationObject.city }
            </p>
            <p className="text-sm text-gray-500 truncate dark:text-gray-400">
              {props.EducationObject.description}
            </p>
          </div>
          <div className="flex items-center space-x-4">
            <button
              onClick={() => props.removeEducation(props.DeletingIndex)}
              type="submit"
